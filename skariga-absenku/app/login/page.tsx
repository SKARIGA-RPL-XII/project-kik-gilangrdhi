        ...
        <div className="relative z-10 w-full max-w-120 mx-4">
            ...
            <div className="text-center mb-10">
                    ...
                    <p className="text-gray-600 text-base">
                        Masuk ke Sistem Absensi Digital <span className="text-transparent bg-clip-text bg-linear-to-r from-sky-500 to-orange-500 font-bold">Skariga</span>
                    </p>
                </div>
                ...
                >
                    ...
                    >
                        <span className="absolute inset-[-1000%] animate-[spin_4s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#0ea5e9_0%,#f97316_50%,#0ea5e9_100%)]" />
                        <span className={`flex h-full w-full cursor-pointer items-center justify-center rounded-[14px] bg-linear-to-r from-sky-500 to-orange-500 hover:from-sky-600 hover:to-orange-600 px-8 py-4 text-base font-bold text-white transition-all gap-2 relative z-10 backdrop-blur-xl shadow-md shadow-sky-500/20`}>
                            {loading ? (
