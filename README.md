...
<p align="center">
  <img src="Assets/logo.png" height="120" alt="Logo">
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <img src="Assets/mascot.png" height="120" alt="Mascot">
  <br><br>
...
<p align="center">
  <b>Entity Relationship Diagram (ERD) & Data Flow Diagram (DFD)</b><br><br>
  <img src="ERD.png" height="300" alt="ERD">
  &nbsp;&nbsp;&nbsp;&nbsp;
  <img src="DFD-Level-0.png" height="300" alt="DFD">
</p>
...
### 🔐 Akses Masuk
<p align="center">
  <img src="Result/halaman%20login.png" width="70%" alt="Login">
  <br>
  <i>Halaman Login Admin & Pembimbing</i>
</p>
...
<p align="center">
  ...
  <img src="Result/list%20user.png" width="48%" alt="User List">
</p>
...
Gunakan perintah khusus ini untuk mengaktifkan **Web Dashboard** dan **Bot Telegram** sekaligus:
```bash
npm run dev:all
```
